...
- Create Angular project with ng: `ng new part365.new.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`part365.new.client.esproj`).
- Create `launch.json` to enable debugging.
- Create `nuget.config` to specify location of the JavaScript Project System SDK (which is used in the first line in `part365.new.client.esproj`).
