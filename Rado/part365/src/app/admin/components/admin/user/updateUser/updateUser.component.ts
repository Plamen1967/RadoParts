...
export class UpdateUserComponent extends HelperComponent implements OnInit, AfterViewInit {
    ...
    confirmationService = inject(ConfirmServiceService)
    ...
    deletUser() {
        ...
        this.updateUserService.deleteUser(userId).subscribe({
            next: (message) => {
    ...
    onPrivateOk() {
        this.updateUserService.userPrivate().subscribe({
            next: (message) => {
                this.message = message
    ...
    onDealerOk() {
        this.updateUserService.userDealer().subscribe({
            next: (message) => {
                this.message = message
