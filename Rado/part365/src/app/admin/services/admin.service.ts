...
export class AdminService {
    ...
    deleteCategory(categoryId: number): Observable<boolean> {
        return this.http.post<boolean>(`${environment.restAPI}/admin/deleteCategory`, categoryId, this.httpHeader).pipe(
            first(),
    ...
    addCategory(categoryName: string): Observable<Category> {
        return this.http.post<Category>(`${environment.restAPI}/admin/addCategory`, JSON.stringify({ categoryName: categoryName, categoryId: 0 }), this.httpHeader).pipe(
            first(),
    ...
    updateSubCategory(subCategory: SubCategory) {
        return this.http.post<SubCategory>(`${environment.restAPI}/admin/updateSubCategory`, JSON.stringify(subCategory), this.httpHeader).pipe(
            first(),
    ...
    addSubCategory(subCategoryName: string) {
        return this.http.post<SubCategory>(`${environment.restAPI}/admin/addSubCategory`, JSON.stringify({ subCategoryName: subCategoryName, subCategoryId: 0 }), this.httpHeader).pipe(
            first(),
    ...
    deleteSubCategory(subCategoryId: number) {
        return this.http.post<boolean>(`${environment.restAPI}/admin/deleteSubCategory`, subCategoryId, this.httpHeader).pipe(
            first(),
    ...
    updateDealerSubCategory(dealerSubCategory: DealerSubCategory) {
        return this.http.post<DealerSubCategory>(`${environment.restAPI}/admin/updateDealerSubCategory`, JSON.stringify(dealerSubCategory), this.httpHeader).pipe(
            first(),
    ...
    deleteDealerSubCategory(dealerSubCategoryId: number) {
        return this.http.post<boolean>(`${environment.restAPI}/admin/deleteDealerSubCategory`, dealerSubCategoryId, this.httpHeader).pipe(
            first(),
    ...
    addSubDealerCategory(dealerSubCategoryName: string) {
        return this.http
            .post<DealerSubCategory>(`${environment.restAPI}/admin/addDealerSubCategory`, JSON.stringify({ dealerSubCategoryName: dealerSubCategoryName, dealerSubCategoryId: 0 }), this.httpHeader)
            .pipe(
                first(),
    ...
    updateCompany(company: Company) {
        return this.http.post<Company>(`${environment.restAPI}/admin/updateCompany`, JSON.stringify(company), this.httpHeader).pipe(
            first(),
    ...
    updateModel(model: Model) {
        return this.http.post<Model>(`${environment.restAPI}/admin/updateModel`, JSON.stringify(model), this.httpHeader).pipe(
            first(),
    ...
    deleteModel(modelId: number) {
        return this.http.post<boolean>(`${environment.restAPI}/admin/deleteModel`, modelId, this.httpHeader).pipe(
            first(),
    ...
    updateModification(modification: Modification) {
        return this.http.post<Modification>(`${environment.restAPI}/admin/updateModification`, JSON.stringify(modification), this.httpHeader).pipe(
            first(),
    ...
    deleteModification(modificationId: number) {
        return this.http.post<boolean>(`${environment.restAPI}/admin/deleteModification`, modificationId, this.httpHeader).pipe(
            first(),
    ...
    updatePassword(guid: string, password: string) {
        return this.http.post<boolean>(`${environment.restAPI}/admin/updatePassword`, { guid: guid, password: password }, this.httpHeader).pipe(
            first(),
    ...
    recoverPassword(userId: number): Observable<string> {
        return this.http.post<string>(`${environment.restAPI}/admin/recoverPassword`, userId, this.httpHeader).pipe(
            first(),
    ...
    suspendUser(userId: number): Observable<User> {
        ...
        return this.http.post<User>(`${environment.restAPI}/admin/suspendUser`, { userId, suspendedDateTime: suspendedDateTime }, this.httpHeader).pipe(
            first(),
    ...
    adminActivateUser(userId: number) {
        return this.http.post<BackendMessage>(`${environment.restAPI}/admin/adminActivateUser/${userId}`, {}).pipe(first());
    }

    adminUnLockUser(userId: number) {
        return this.http.post<BackendMessage>(`${environment.restAPI}/admin/adminUnLockUser/${userId}`, {}).pipe(first());
    }

    adminDeleteUser(userId: number) {
        return this.http.post(`${environment.restAPI}/admin/adminDeleteUser/${userId}`, {}, { responseType: 'text' }).pipe(first());
    }
    ...
    unSuspendUser(userId: number): Observable<User> {
        return this.http.post<User>(`${environment.restAPI}/admin/unsuspendUser`, { userId, suspendDateTime: 0 }, this.httpHeader).pipe(
            first(),
            tap(() => this.loggerService.log(`recover Password: ${userId}`))
        )
    }
