...
export class NgxImgZoomComponent implements AfterViewInit, OnDestroy {
    ...
    private ngxZoomService: NgxImgZoomService = inject(NgxImgZoomService)
    ...
    ngOnDestroy() {
        if (this.lensMouseMoveListener) {
            this.lensMouseMoveListener()
        }
        if (this.imgMouseMoveListener) {
            this.imgMouseMoveListener()
        }
        if (this.imgTouchMoveListener) {
            this.imgTouchMoveListener()
        }
        if (this.lensTouchMoveListener) {
